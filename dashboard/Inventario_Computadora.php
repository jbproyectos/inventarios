...
<head>
    ...
    <style>
        ...
        .export-dropdown-content ul {
            list-style: none;
            margin: 0;
            padding: 0;
        }

        .export-dropdown-content li button {
            width: 100%;
            text-align: left;
            padding: 0.5rem 1rem;
            border: none;
        ...
        .export-dropdown-content li button:hover {
                            ...
                            <div class=" sm:rounded-lg">
                                <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white ">
                                    <div class="">
                                        ...
                                        <!-- Botón de Filtros -->
                                        <button id="openFilterModal" type="button" class="border-l border-gray-200 inline-flex text-gray-500 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-5 py-2.5 text-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        ...
                                        <div class="export-dropdown">
                                            <button id="exportDropdownButton" type="button" class="border-l border-gray-200 inline-flex text-gray-500 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-5 py-2.5 text-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            ...
                                            <div id="exportDropdown" class="export-dropdown-content">
                                                <ul>
                                                    <li>
                                                        <button onclick="exportarExcel()">Excel (todos)</button>
                                                    </li>
                                                    <li>
                                                        <button onclick="exportarExcelFiltrados()">Excel (filtrados)</button>
                                                    </li>
                                                    <li>
                                                        <button onclick="exportarPDF()">PDF (todos)</button>
                                                    </li>
                                                    <li>
                                                        <button onclick="exportarPDFFiltrados()">PDF (filtrados)</button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
SO:               Get-ComputerInfo | Select WindowsProductName,WindowsVersion,OsHardwareAbstractionLayer
                                    ...
                                    <form method="GET" class="mb-4">
                                        ...
                                        $filtrosParaMantener = [
                                            ...
                                            'filtro_asignado',
                                            'filtro_modelo',
                                            'filtro_fecha_asignacion'
                                        ];

                                        foreach ($filtrosParaMantener as $filtro) {
                                ...
                                <div id="filtrosActivos" class="mb-4 p-3 bg-gray-50 rounded-lg light:bg-gray-700" <?= $hayFiltros ? '' : 'style="display: none;"' ?>>
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-2">
                                            <span class="text-sm font-medium text-gray-700 light:text-gray-300">Filtros activos:</span>
                                            <div id="filtrosTags" class="flex flex-wrap gap-2">
                                                <?php
                                                ...
                                                $filtrosLabels = [
                                                    ...
                                                    'filtro_procesador' => 'Procesador',
                                                    'filtro_ram' => 'RAM',
                                                    'filtro_costo_min' => 'Costo Mín',
                                                    'filtro_costo_max' => 'Costo Máx',
                                                    'filtro_asignado' => 'Asignado a',
                                                    'filtro_modelo' => 'Modelo',
                                                    'filtro_fecha_asignacion' => 'Fecha Asignación',
                                                    'search' => 'Búsqueda'
                                                ];

                                                foreach ($filtrosLabels as $key => $label) {
                                                    if (isset($_GET[$key]) && !empty($_GET[$key])) {
                                                        echo '<span class="filter-badge light:bg-blue-900 light:text-blue-200">';
                                                        echo $label . ': ' . htmlspecialchars($_GET[$key]);
                                                        echo '<button type="button" onclick="removerFiltro(\'' . $key . '\')">&times;</button>';
                                                        echo '</span>';
                                                    }
                                                }
                                                ?>
                                        ...
                                        <button id="quitarFiltrosBtn" type="button" class="text-sm text-red-600 hover:text-red-800 light:text-red-400">Quitar todos</button>
                                    </div>
                                </div>

                                <!-- Modal de Filtros -->
                                <div id="filterModal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-4xl max-h-full">
                                        <div class="relative bg-white rounded-lg shadow light:bg-gray-700">
                                            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t light:border-gray-600">
                                                ...
                                                <button type="button" id="cerrarFiltrosBtn" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center light:hover:bg-gray-600 light:hover:text-white">
                                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                                    </svg>
                                                </button>
                                            ...
                                            <div class="p-4 md:p-5">
                                                <form id="filtrosForm" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                    <?php
                                                    // Función para obtener valores únicos
                                                    function obtenerValoresUnicos($conexion, $campo, $tabla = 'computadora')
                                                    {
                                                        try {
                                                            $query = "SELECT DISTINCT $campo FROM $tabla WHERE $campo IS NOT NULL AND $campo != '' ORDER BY $campo";
                                                            $stmt = $conexion->prepare($query);
                                                            $stmt->execute();
                                                    ...
                                                    <?php
                                                    // Tipo
                                                    $tipos = obtenerValoresUnicos($conexion, 'tipo');
                                                    ?>
                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Tipo</label>
                                                        <select name="filtro_tipo" id="filtro_tipo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500">
                                                            <option value="">Todos los tipos</option>
                                                            <?php foreach ($tipos as $tipo): ?>
                                                                <option value="<?= htmlspecialchars($tipo) ?>" <?= (isset($_GET['filtro_tipo']) && $_GET['filtro_tipo'] == $tipo) ? 'selected' : '' ?>>
                                                    ...
                                                    <?php
                                                    // Status
                                                    $statuses = obtenerValoresUnicos($conexion, 'status');
                                                    ?>
                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Status</label>
                                                        <select name="filtro_status" id="filtro_status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500">
                                                            <option value="">Todos los status</option>
                                                            <?php foreach ($statuses as $status): ?>
                                                                <option value="<?= htmlspecialchars($status) ?>" <?= (isset($_GET['filtro_status']) && $_GET['filtro_status'] == $status) ? 'selected' : '' ?>>
                                                    ...
                                                    // Oficinas
                                                    try {
                                                        $queryOficinas = "SELECT DISTINCT o.nombre FROM oficina o 
                                                                        JOIN computadora c ON o.Id_Oficina = c.Id_Oficina 
                                                                        ORDER BY o.nombre";
                                                        $stmtOficinas = $conexion->prepare($queryOficinas);
                                                        $stmtOficinas->execute();
                                                        $oficinas = $stmtOficinas->fetchAll(PDO::FETCH_COLUMN);
                                                    } catch (Exception $e) {
                                                        $oficinas = [];
                                                    }
                                                    ?>
                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Oficina</label>
                                                        <select name="filtro_oficina" id="filtro_oficina" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500">
                                                            <option value="">Todas las oficinas</option>
                                                            <?php foreach ($oficinas as $oficina): ?>
                                                                <option value="<?= htmlspecialchars($oficina) ?>" <?= (isset($_GET['filtro_oficina']) && $_GET['filtro_oficina'] == $oficina) ? 'selected' : '' ?>>
                                                                    <?= htmlspecialchars($oficina) ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    // Departamentos
                                                    try {
                                                        $queryDeptos = "SELECT DISTINCT d.nombre FROM departamentos d 
                                                                      JOIN computadora c ON d.Id_departamento = c.Id_departamento 
                                                                      ORDER BY d.nombre";
                                                        $stmtDeptos = $conexion->prepare($queryDeptos);
                                                        $stmtDeptos->execute();
                                                        $departamentos = $stmtDeptos->fetchAll(PDO::FETCH_COLUMN);
                                                    } catch (Exception $e) {
                                                        $departamentos = [];
                                                    }
                                                    ?>
                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Departamento</label>
                                                        <select name="filtro_departamento" id="filtro_departamento" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500">
                                                            <option value="">Todos los departamentos</option>
                                                            <?php foreach ($departamentos as $depto): ?>
                                                                <option value="<?= htmlspecialchars($depto) ?>" <?= (isset($_GET['filtro_departamento']) && $_GET['filtro_departamento'] == $depto) ? 'selected' : '' ?>>
                                                    ...
                                                    <?php
                                                    // Disponibilidad
                                                    $disponibilidades = obtenerValoresUnicos($conexion, 'disponibilidad');
                                                    ?>
                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Disponibilidad</label>
                                                        <select name="filtro_disponibilidad" id="filtro_disponibilidad" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500">
                                                            <option value="">Todas las disponibilidades</option>
                                                            <?php foreach ($disponibilidades as $disp): ?>
                                                                <option value="<?= htmlspecialchars($disp) ?>" <?= (isset($_GET['filtro_disponibilidad']) && $_GET['filtro_disponibilidad'] == $disp) ? 'selected' : '' ?>>
                                                    ...
                                                    <?php
                                                    // Procesador
                                                    $procesadores = obtenerValoresUnicos($conexion, 'procesador');
                                                    ?>
                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Procesador</label>
                                                        <select name="filtro_procesador" id="filtro_procesador" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500">
                                                            <option value="">Todos los procesadores</option>
                                                            <?php foreach ($procesadores as $proc): ?>
                                                                <option value="<?= htmlspecialchars($proc) ?>" <?= (isset($_GET['filtro_procesador']) && $_GET['filtro_procesador'] == $proc) ? 'selected' : '' ?>>
                                                    ...
                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">RAM (GB)</label>
                                                        <select name="filtro_ram" id="filtro_ram" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500">
                                                            <option value="">Todas las RAM</option>
                                                            <option value="4" <?= (isset($_GET['filtro_ram']) && $_GET['filtro_ram'] == '4') ? 'selected' : '' ?>>4 GB</option>
                                                            <option value="8" <?= (isset($_GET['filtro_ram']) && $_GET['filtro_ram'] == '8') ? 'selected' : '' ?>>8 GB</option>
                                                            <option value="16" <?= (isset($_GET['filtro_ram']) && $_GET['filtro_ram'] == '16') ? 'selected' : '' ?>>16 GB</option>
                                                            <option value="32" <?= (isset($_GET['filtro_ram']) && $_GET['filtro_ram'] == '32') ? 'selected' : '' ?>>32 GB</option>
                                                            <option value="64" <?= (isset($_GET['filtro_ram']) && $_GET['filtro_ram'] == '64') ? 'selected' : '' ?>>64 GB o más</option>
                                                        </select>
                                                    </div>

                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Costo Mínimo</label>
                                                        <input type="number" name="filtro_costo_min" id="filtro_costo_min"
                                                            value="<?= isset($_GET['filtro_costo_min']) ? htmlspecialchars($_GET['filtro_costo_min']) : '' ?>"
                                                    ...
                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Costo Máximo</label>
                                                        <input type="number" name="filtro_costo_max" id="filtro_costo_max"
                                                            value="<?= isset($_GET['filtro_costo_max']) ? htmlspecialchars($_GET['filtro_costo_max']) : '' ?>"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500"
                                                            placeholder="100000">
                                                    </div>

                                                    <div class="md:col-span-2">
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Asignado a</label>
                                                        <input type="text" name="filtro_asignado" id="filtro_asignado"
                                                            value="<?= isset($_GET['filtro_asignado']) ? htmlspecialchars($_GET['filtro_asignado']) : '' ?>"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500"
                                                            placeholder="Nombre del asignado">
                                                    </div>

                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Modelo</label>
                                                        <input type="text" name="filtro_modelo" id="filtro_modelo"
                                                            value="<?= isset($_GET['filtro_modelo']) ? htmlspecialchars($_GET['filtro_modelo']) : '' ?>"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500"
                                                            placeholder="Modelo específico">
                                                    </div>

                                                    <div>
                                                        <label class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Fecha de Asignación</label>
                                                        <input type="date" name="filtro_fecha_asignacion" id="filtro_fecha_asignacion"
                                                            value="<?= isset($_GET['filtro_fecha_asignacion']) ? htmlspecialchars($_GET['filtro_fecha_asignacion']) : '' ?>"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500">
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b light:border-gray-600">
                                                <button type="button" id="aplicarFiltrosBtn" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800">
                                                    Aplicar Filtros
                                                </button>
                                                <button type="button" id="limpiarFiltrosBtn" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 light:bg-gray-700 light:border-gray-600 light:text-white light:hover:bg-gray-600 light:hover:text-white light:focus:ring-gray-700">
                                                    Limpiar Formulario
                                                </button>
                                                <button type="button" id="cancelarFiltrosBtn" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 light:bg-gray-700 light:border-gray-600 light:text-white light:hover:bg-gray-600 light:hover:text-white light:focus:ring-gray-700">
                                                    Cancelar
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            try {
                                                ...
                                                $query = "
                                                    ...
                                                    WHERE computadora.Id_departamento IN (
                                                ...
                                                if (isset($_GET['filtro_marca']) && !empty($_GET['filtro_marca'])) {
                                                    $query .= " AND computadora.marca = :marca";
                                                    $params[':marca'] = $_GET['filtro_marca'];
                                                    $filtrosAplicados['marca'] = $_GET['filtro_marca'];
                                                }

                                                if (isset($_GET['filtro_tipo']) && !empty($_GET['filtro_tipo'])) {
                                                    $query .= " AND computadora.tipo = :tipo";
                                                    $params[':tipo'] = $_GET['filtro_tipo'];
                                                    $filtrosAplicados['tipo'] = $_GET['filtro_tipo'];
                                                }

                                                if (isset($_GET['filtro_status']) && !empty($_GET['filtro_status'])) {
                                                    $query .= " AND computadora.status = :status";
                                                    $params[':status'] = $_GET['filtro_status'];
                                                    $filtrosAplicados['status'] = $_GET['filtro_status'];
                                                }

                                                if (isset($_GET['filtro_oficina']) && !empty($_GET['filtro_oficina'])) {
                                                    $query .= " AND oficina.nombre = :oficina";
                                                    $params[':oficina'] = $_GET['filtro_oficina'];
                                                    $filtrosAplicados['oficina'] = $_GET['filtro_oficina'];
                                                }

                                                if (isset($_GET['filtro_departamento']) && !empty($_GET['filtro_departamento'])) {
                                                    $query .= " AND departamentos.nombre = :departamento";
                                                    $params[':departamento'] = $_GET['filtro_departamento'];
                                                    $filtrosAplicados['departamento'] = $_GET['filtro_departamento'];
                                                }

                                                if (isset($_GET['filtro_disponibilidad']) && !empty($_GET['filtro_disponibilidad'])) {
                                                    $query .= " AND computadora.disponibilidad = :disponibilidad";
                                                    $params[':disponibilidad'] = $_GET['filtro_disponibilidad'];
                                                    $filtrosAplicados['disponibilidad'] = $_GET['filtro_disponibilidad'];
                                                }

                                                if (isset($_GET['filtro_procesador']) && !empty($_GET['filtro_procesador'])) {
                                                    $query .= " AND computadora.procesador = :procesador";
                                                    $params[':procesador'] = $_GET['filtro_procesador'];
                                                    $filtrosAplicados['procesador'] = $_GET['filtro_procesador'];
                                                }

                                                if (isset($_GET['filtro_ram']) && !empty($_GET['filtro_ram'])) {
                                                    $query .= " AND computadora.ram = :ram";
                                                    $params[':ram'] = $_GET['filtro_ram'];
                                                    $filtrosAplicados['ram'] = $_GET['filtro_ram'];
                                                }

                                                if (isset($_GET['filtro_costo_min']) && !empty($_GET['filtro_costo_min'])) {
                                                    $query .= " AND computadora.costoEquipoActual >= :costo_min";
                                                    $params[':costo_min'] = $_GET['filtro_costo_min'];
                                                    $filtrosAplicados['costo_min'] = $_GET['filtro_costo_min'];
                                                }

                                                if (isset($_GET['filtro_costo_max']) && !empty($_GET['filtro_costo_max'])) {
                                                    $query .= " AND computadora.costoEquipoActual <= :costo_max";
                                                    $params[':costo_max'] = $_GET['filtro_costo_max'];
                                                    $filtrosAplicados['costo_max'] = $_GET['filtro_costo_max'];
                                                }

                                                if (isset($_GET['filtro_asignado']) && !empty($_GET['filtro_asignado'])) {
                                                    $query .= " AND computadora.asignado_a LIKE :asignado";
                                                    $params[':asignado'] = '%' . $_GET['filtro_asignado'] . '%';
                                                    $filtrosAplicados['asignado'] = $_GET['filtro_asignado'];
                                                }

                                                if (isset($_GET['filtro_modelo']) && !empty($_GET['filtro_modelo'])) {
                                                    $query .= " AND computadora.modelo LIKE :modelo";
                                                    $params[':modelo'] = '%' . $_GET['filtro_modelo'] . '%';
                                                    $filtrosAplicados['modelo'] = $_GET['filtro_modelo'];
                                                }

                                                if (isset($_GET['filtro_fecha_asignacion']) && !empty($_GET['filtro_fecha_asignacion'])) {
                                                    $query .= " AND DATE(computadora.fechaDeAsignacion) = :fecha_asignacion";
                                                    $params[':fecha_asignacion'] = $_GET['filtro_fecha_asignacion'];
                                                    $filtrosAplicados['fecha_asignacion'] = $_GET['filtro_fecha_asignacion'];
                                                }
                                                ...
                                                if (isset($_GET['search']) && !empty($_GET['search'])) {
                                                    $search = $_GET['search'];
                                                    $query .= " AND (
                                                        computadora.marca LIKE :search OR
                                                        computadora.modelo LIKE :search OR
                                                        computadora.procesador LIKE :search OR
                                                        computadora.asignado_a LIKE :search OR
                                                        departamentos.nombre LIKE :search
                                                    )";
                                                    $params[':search'] = "%$search%";
                                                    $filtrosAplicados['search'] = $_GET['search'];
                                                }

                                                // Contar total de registros filtrados
                                                $queryCount = "SELECT COUNT(*) FROM ($query) AS count_table";
                                                ...
                                                if ($resultado) {
                                                    ...
                                                    echo '<tr><td colspan="10" class="px-6 py-4 text-center">No se encontraron registros.</td></tr>';
                                                }
                                            } catch (PDOException $e) {
                                                echo '<tr><td colspan="10" class="px-6 py-4 text-center text-red-500">Error: ' . htmlspecialchars($e->getMessage()) . '</td></tr>';
                                            }
                                    ...
                                    <div class="paginacion mt-4">
                                        <ul class="flex justify-left space-x-2">
                                            ...
                                            <?php if ($paginaActual > 1): ?>
                                                <li>
                                                    <a href="<?= $urlBase ?>pagina=<?= $paginaActual - 1 ?>" class="px-4 py-2 bg-gray-200 rounded-md hover:bg-gray-300">
                                                        &laquo; <!-- Esto es « -->
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                            ...
                                            if ($startPage > 1) {
                                                echo '<li><a href="' . $urlBase . 'pagina=1" class="px-4 py-2 bg-gray-200 rounded-md hover:bg-gray-300">1</a></li>';
                                                if ($startPage > 2) {
                                            ...
                                            for ($i = $startPage; $i <= $endPage; $i++) {
                                                echo '<li>';
                                                echo '<a href="' . $urlBase . 'pagina=' . $i . '" class="px-4 py-2 ' . ($i == $paginaActual ? 'bg-blue-500 text-white' : 'bg-gray-200 hover:bg-gray-300') . ' rounded-md">' . $i . '</a>';
                                                echo '</li>';
                                            }
                                            ...
                                            if ($endPage < $totalPaginas) {
                                                ...
                                                echo '<li><a href="' . $urlBase . 'pagina=' . $totalPaginas . '" class="px-4 py-2 bg-gray-200 rounded-md hover:bg-gray-300">' . $totalPaginas . '</a></li>';
                                            }
                                            ?>
    ...
    <script>
        // Script para vista previa de archivos CSV/TXT
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (openFilterBtn) {
                console.log('Botón de abrir filtros encontrado');
                ...
                console.warn('Botón de abrir filtros NO encontrado');
            }
            ...
            if (limpiarFiltrosBtn) {
                limpiarFiltrosBtn.addEventListener('click', function() {
                    console.log('Limpiando formulario de filtros');
            ...
            if (cancelarFiltrosBtn) {
                cancelarFiltrosBtn.addEventListener('click', function() {
            ...
            if (quitarFiltrosBtn) {
                quitarFiltrosBtn.addEventListener('click', function() {
                    console.log('Quitando todos los filtros');
            ...
            if (exportDropdownButton && exportDropdown) {
                ...
                document.addEventListener('click', function(event) {
                    if (exportDropdownButton && !exportDropdownButton.contains(event.target) &&
        ...
        function aplicarFiltros() {
            ...
            // Limpiar parámetros de filtro previos
            const paramsToRemove = ['filtro_marca', 'filtro_tipo', 'filtro_status', 'filtro_oficina',
                'filtro_departamento', 'filtro_disponibilidad', 'filtro_procesador',
                'filtro_ram', 'filtro_costo_min', 'filtro_costo_max', 'filtro_asignado',
                'filtro_modelo', 'filtro_fecha_asignacion', 'pagina', 'search'
            ];
    ...
    <script>
        $(document).ready(function() {
            // Características de computadora
            $('[data-drawer-show="drawer-right-example"]').on('click', function() {
                ...
                $.ajax({
                    ...
                    <?php } else { ?>
                        <span class='text-red-500'>*Tu usuario no tiene acceso a ver las contrasenas*</span>
                    <?php } ?>
                    ...
                    <div class="mb-2">
                        ...
                        <?php } else { ?>
                            <span class='text-red-500'>*Sin acceso*</span>
                        <?php } ?>
                    </div>
                    <div class="mb-2">
    ...
    <!-- Scripts para CRUD de computadoras -->
    <script>
        $(document).ready(function() {
            ...
            // Eliminar todas las computadoras
            $('#elimina_compu').on('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'computadora/DeleteTable.php',
                            data: {
    ...
    <!-- Scripts para filtros y selección de empleados -->
    <script>
        $(document).ready(function() {
                        ...
                        success: function(response) {
                            if (response.status === 'success') {
                                ...
                                empleados.forEach(function(empleado) {
                                    $('#asignado_a').append(new Option(empleado.nombre, empleado.nombre));
                                });
                            } else {
                                Swal.fire({
                                    title: 'Error',
        ...
        document.getElementById('applyFiltersButton').addEventListener('click', function() {
            ...
            const data = [
                ['Fecha', 'Estado'],
                [filterDate || 'N/A', filterStatus || 'N/A']
            ];
    ...
    <!-- Scripts para edición de equipos -->
    <script>
        // Abrir modal de edición
        $('[data-modal-target="crud-edit"]').on('click', function() {
            var idCom = $(this).data('id-com');
            rellenarModal(idCom);
        });
        ...
        function rellenarModal(idCom) {
            fetch('computadora/edit_equipo.php?Id_computadora=' + idCom)
                ...
                .then(data => {
                    ...
                    $('#id_equipo').val(data.Id_computadora);
                    $('#asignado_a_edit').val(data.asignado_a);
    ...
    <!-- Script para marcar registros como revisados -->
    <script>
...
<script>
    // Función para exportar a Excel (todos)
    function exportarExcel() {
        Swal.fire({
            title: 'Exportando a Excel',
            text: 'Preparando todos los registros para exportar...',
            icon: 'info',
            showCancelButton: true,
            ...
            preConfirm: () => {
                return fetch('computadora/exportar_excel.php?tipo=todos')
                    .then(response => {
                        if (!response.ok) {
                    ...
                    .then(blob => {
                        ...
                        const a = document.createElement('a');
                        a.href = url;
                        a.download = 'computadoras_todos_' + new Date().toISOString().slice(0,10) + '.xlsx';
    ...
    // Función para exportar a Excel (filtrados)
     exportarExcelFiltrados() {
        // Obtener parámetros actuales de filtro de la URL
        const urlParams = new URLSearchParams(window.location.search);
        const parametrosFiltro = {};
        
        // Lista de posibles parámetros de filtro
        const filtrosPosibles = [
            'filtro_marca', 'filtro_tipo', 'filtro_status', 'filtro_oficina',
            'filtro_departamento', 'filtro_disponibilidad', 'filtro_procesador',
            'filtro_ram', 'filtro_costo_min', 'filtro_costo_max', 'filtro_asignado',
            'filtro_modelo', 'filtro_fecha_asignacion', 'search'
        ];
        
        // Construir objeto con los filtros actuales
        filtrosPosibles.forEach(filtro => {
            if (urlParams.has(filtro)) {
                parametrosFiltro[filtro] = urlParams.get(filtro);
            }
        });
        
        // Verificar si hay filtros activos
        const tieneFiltros = Object.keys(parametrosFiltro).length > 0;
        
        if (!tieneFiltros) {
            Swal.fire({
                title: 'Sin filtros',
                text: 'No hay filtros activos. ¿Deseas exportar todos los registros?',
                icon: 'warning',
                showCancelButton: true,
        ...
        Swal.fire({
            title: 'Exportando a Excel',
            text: 'Preparando registros filtrados para exportar...',
            icon: 'info',
            showCancelButton: true,
            confirmButtonText: 'Continuar',
            cancelButtonText: 'Cancelar',
            ...
            preConfirm: () => {
                ...
                const queryString = new URLSearchParams(parametrosFiltro).toString();
                
                return fetch(`computadora/exportar_excel.php?tipo=filtrados&${queryString}`)
                    .then(response => {
                        if (!response.ok) {
                            throw new Error('Error en la respuesta del servidor');
                        }
                    ...
                    .then(blob => {
                        ...
                        const a = document.createElement('a');
                        a.href = url;
                        a.download = 'computadoras_filtrados_' + new Date().toISOString().slice(0,10) + '.xlsx';
                        document.body.appendChild(a);
                        a.click();
                        window.URL.revokeObjectURL(url);
                        document.body.removeChild(a);
    ...
    // Función para exportar a PDF (todos)
    function exportarPDF() {
        Swal.fire({
            ...
            showLoaderOnConfirm: true,
            preConfirm: () => {
                return fetch('computadora/exportar_pdf.php?tipo=todos')
                    .then(response => {
                        if (!response.ok) {
                            throw new Error('Error en la respuesta del servidor');
                        }
                    ...
                    .then(blob => {
                        ...
                        const a = document.createElement('a');
                        a.href = url;
                        a.download = 'computadoras_todos_' + new Date().toISOString().slice(0,10) + '.pdf';
                        document.body.appendChild(a);
                        a.click();
                        window.URL.revokeObjectURL(url);
                        document.body.removeChild(a);
            ...
            if (result.isConfirmed && result.value.success) {
                Swal.fire({
                    title: '¡Éxito!',
                    text: 'Archivo PDF exportado correctamente',
                    icon: 'success',
                    confirmButtonColor: '#4b5563',
                    confirmButtonText: 'Aceptar'
                });
    ...
    // Función para exportar a PDF (filtrados)
    function exportarPDFFiltrados() {
        // Obtener parámetros actuales de filtro de la URL
        const urlParams = new URLSearchParams(window.location.search);
        const parametrosFiltro = {};
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                ...
                return fetch(`computadora/exportar_pdf.php?tipo=filtrados&${queryString}`)
                    .then(response => {
                        if (!response.ok) {
                            throw new Error('Error en la respuesta del servidor');
                        }
                    ...
                    .then(blob => {
                        ...
                        const a = document.createElement('a');
                        a.href = url;
                        a.download = 'computadoras_filtrados_' + new Date().toISOString().slice(0,10) + '.pdf';
                        document.body.appendChild(a);
                        a.click();
                        window.URL.revokeObjectURL(url);
                        document.body.removeChild(a);
