...
<head>
    ...
    <title>Mis solicitudes | Sistema</title>
            ...
            <main class=" justify-center items-center bg-gray-100 dark:bg-gray-900">
                <div class="container px-6 sm:px-2 mx-auto">
                    ...
                    <div class="flex h-auto flex-col gap-6 mt-8 mb-8 md:flex-row">
                        ...
                        <!-- segundo div que abarca dos columnas -->
                                                        ...
                                                        while ($rowTablaDinamica = $stmtTablaDinamica->fetch(PDO::FETCH_ASSOC)) {
                                                            ...
                                                            $sql = "SELECT
                                                                        ...
                                                                        LEFT JOIN
                                                                            ...
                                                                            WHERE solicitudbaja.Id_usuario = $user_id";
                                                            ...
                                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                                ...
                                                                <button type="button" data-drawer-target="drawer-right-example" data-drawer-show="drawer-right-example" data-drawer-placement="right" aria-controls="drawer-right-example" type="button" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-2 py-2 mb-2 dark:focus:ring-yellow-900">Rastrear</button>
                                                                </td>';
                                                                    echo '</tr>';
