...
<div class="col-span-2 sm:col-span-1">
    <label for="asignado_a" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">
        Asignado A <span class="text-red-500">*</span>
    </label>
    <select id="asignado_a" name="asignado_a" class="block p-2 text-sm text-gray-900 border border-gray-300 w-full rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white">
...
new TomSelect("#asignado_a", {
    create: true,       // permite escribir nombres nuevos
    sortField: {
        field: "text",
        direction: "asc"
    }
                                                                    ...
                                                                    <div class="col-span-2 sm:col-span-1">
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            <option value="Descontinuada">En mantenimiento</option>
    ...
    <p class="text-sm text-gray-500 light:text-gray-400 mb-4">Cuentas</p>

    <div id="cuentas-container" class="grid gap-5">
        <!-- Bloque inicial: una cuenta, dos columnas -->
        <div class="grid gap-5 grid-cols-2">
            <div>
                <label for="correo1" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Correo <span class="text-red-500">*</span></label>
                <input type="text" name="correo1" id="correo1" required placeholder="desarrollo@example.org" class="block p-2 text-sm text-gray-900 border border-gray-300 w-full rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white">
            </div>
            <div>
                <label for="contrasena1" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Contraseña <span class="text-red-500">*</span></label>
                <input type="text" name="contrasena1" id="contrasena1" required placeholder="********" class="block p-2 text-sm text-gray-900 border border-gray-300 w-full rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white">
            </div>
        </div>
    </div>

    <button type="button" id="add-account" class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Agregar cuenta</button>
</div>

<script>
let cuentaCount = 1; // Bloque inicial
document.getElementById('add-account').addEventListener('click', () => {
    cuentaCount++;
    const container = document.getElementById('cuentas-container');
    const newFields = document.createElement('div');
    newFields.classList.add('grid', 'gap-5', 'grid-cols-2', 'mt-2'); // Nueva fila de 2 columnas
    newFields.innerHTML = `
        <div>
            <label for="correo${cuentaCount}" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Correo ${cuentaCount}</label>
            <input type="text" name="correo${cuentaCount}" id="correo${cuentaCount}" placeholder="desarrollo@example.org" class="block p-2 text-sm text-gray-900 border border-gray-300 w-full rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white">
        </div>
        <div>
            <label for="contrasena${cuentaCount}" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Contraseña ${cuentaCount}</label>
            <input type="text" name="contrasena${cuentaCount}" id="contrasena${cuentaCount}" placeholder="********" class="block p-2 text-sm text-gray-900 border border-gray-300 w-full rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white">
        </div>
    `;
