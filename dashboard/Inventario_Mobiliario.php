                            ...
                            <div class=" sm:rounded-lg">
                                <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white ">
                                    <div class="">
                                        ...
                                        <?php } ?>
<button id="verMapaBtn" class="inline-flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 me-2 font-medium rounded-lg text-sm px-5 py-2.5 text-center">

    Ver mapa
</button>

<!-- Modal -->
<div id="mapModal" class="hidden fixed top-0 left-0 w-full h-full bg-black/50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg w-11/12 md:w-3/4 lg:w-1/2 h-3/4 relative">
        <button id="cerrarMapa" class="absolute top-2 right-2 bg-red-500 text-white px-3 py-1 rounded-lg">Cerrar</button>
...
echo '<td class="px-6 py-4">'.implode(' - ', $empresas).'</td>';
