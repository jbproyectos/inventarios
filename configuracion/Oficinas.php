...
<body>
                                ...
                                <div class="">
                                    ...
                                    <div class=" sm:rounded-lg">
                                                            ...
                                                            <form method="#" class="p-4 md:p-5">
                                                                <div class="grid gap-6 mb-6 md:p-4">
                                                                    ...
                                                                    <div class="mb-6">
                                                                        ...
                                                                        <input type="text" name="direccion" id="direccion" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 w-full rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                                                                    </div>
                                                                </div>
                                        ...
                                        <div style="overflow-x: auto;" class="h-auto">
                                                    ...
                                                    try {
                                                        ...
                                                        if ($resultado->rowCount() > 0) {
                                                            foreach ($resultado as $fila) {
                                                                ...
                                                                echo '<td class="px-6 py-4">' . $fila['direccion'] . '</td>';
                                            ...
                                            $totalRecordsQuery = "SELECT COUNT(*) as total FROM oficina";
    ...
    <script src="oficina/scriptOficina.js"></script>
