...
<body>
                                ...
                                <div class="">
                                    ...
                                    <div class=" sm:rounded-lg">
                                                        ...
                                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                            ...
                                                            <form method="#" class="p-4 md:p-5">
                                                                <div class="grid gap-6 mb-6 md:p-4">
                                                                    <div class="mb-6">
                                                                        <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre de rol</label>
                                                                        <input type="text" name="nombre_rol" id="nombre_rol" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 w-full rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                                                                    </div>
                                                                    <div class="mb-6">
                                                                        <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sub Nombre</label>
                                                                        <input type="text" name="subname" id="subname" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 w-full rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                                                                    </div>
                                                                </div>
                                        ...
                                        <div style="overflow-x: auto;" class="h-auto">
                                                    ...
                                                    try {
                                                        ...
                                                        if ($resultado->rowCount() > 0) {
                                                            foreach ($resultado as $fila) {
                                                                ...
                                                                echo '<td class="px-6 py-4">' . $fila['descripcion'] . '</td>';
                                            ...
                                            $totalRecordsQuery = "SELECT COUNT(*) as total FROM roles";
    ...
    <script src="role/scriptRole.js"></script>
